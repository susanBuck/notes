...
Fx.Accordion = Accordion;var Window = window;
...
Json.evaluate = Json.decode;window.extend(Client);Element.$domCompatMethods = {
...
document.extend(Element.$domCompatMethods);Hash.implement({
